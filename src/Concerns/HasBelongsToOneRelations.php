...
use Baril\Smoothie\Relations\BelongsToOne;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Support\Arr;

trait HasBelongsToOneRelations
{
    /**
     * Define a many-to-one with pivot table relationship.
     *
    ...
    protected function guessBelongsToOneRelation()
    {
        $caller = Arr::first(debug_backtrace(DEBUG_BACKTRACE_IGNORE_ARGS), function ($trace) {
            return ! in_array(
                $trace['function'],
                array_merge(static::$manyMethods, ['guessBelongsToOneRelation'])
            );
        });
